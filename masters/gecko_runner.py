...
counter = 5
while counter != 0:
    site = GeckoReviewSpider("https://www.tripadvisor.com/Attraction_Review-g274873-d12987385-Reviews"
                             "-Avtobusna_postaja_Ljubljana-Ljubljana_Upper_Carniola_Region.html")
