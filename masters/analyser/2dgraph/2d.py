...
#Zemljepisna širina
    ...
    au_dataset = {'Zemljepisna dolžina': au_x_arr, 'Zemljepisna širina': au_y_arr}
    ...
    sns.scatterplot(x=audset['Zemljepisna dolžina'], y=audset['Zemljepisna širina'], color="#ccc", label="Avstrija")
